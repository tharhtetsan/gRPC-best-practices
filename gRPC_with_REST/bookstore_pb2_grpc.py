...
class BookServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetBooks = channel.unary_unary(
                ...
                response_deserializer=bookstore__pb2.BookList.FromString,
...
def add_BookServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetBooks': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=bookstore__pb2.BookList.SerializeToString,
            ),
...
class BookService(object):
    ...
    def GetBooks(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            bookstore__pb2.BookList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
